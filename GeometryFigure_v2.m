...
inputfiles={'ThwaitesA_v2.mat';...
    'ThwaitesB_v2.mat';...
    'ThwaitesC_v2.mat'};
figname='/home/mjw/Documents/FjordSillPaper/Figures/ThwaitesSettingFigure_v2.png';
insetfigname='/home/mjw/Documents/FjordSillPaper/Figures/ThwaitesSettingFigure_v2_inset.png';
...
bedlims=[-2000,-500];            % [1x2] m
bedcmap='parula';                % valid colormap string
...
hold on
% Plot grounding line:
%contour(X/1000,Y/1000,Mask,.5*[1,1],'LineWidth',1.5*linewidth,'Color','w')
% Plot contours of distance:
if distcontour~=0
    Distance(InFlowBand==0)=NaN;
    contour(X/1000,Y/1000,Distance,[0:distcontour*1000:pathlength],'k','LineWidth',linewidth)
    contour(X/1000,Y/1000,Distance,[0:-distcontour*1000:min(Distance(:))],'k','LineWidth',linewidth)
end
% Plot wide boundaries:
plot([Boundaries(1).X_boundary;Boundaries(1).X_boundary(1)]/1000,...
    [Boundaries(1).Y_boundary;Boundaries(1).Y_boundary(1)]/1000,'w','LineWidth',1.5*linewidth)
plot([Boundaries(1).X_boundary;Boundaries(1).X_boundary(1)]/1000,...
