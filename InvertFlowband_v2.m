...
% THIS IS THE VERSION OF InvertFlowband THAT WAS USED FOR THE FINAL
% PRODUCT.
...
inputfiles={'PineIslandFlowband_v6.mat';...
    'PineIslandFlowband_v7.mat';...
    'PineIslandFlowband_v8.mat';...
    'ThwaitesFlowband_v3.mat';...
    'ThwaitesFlowband_v4.mat';...
    'ThwaitesFlowband_v5.mat'};
...
SurfElev_input=fliplr(SurfElev_flowband');
...
if exist('AreaConservingWidth_flowband','var')
    Width_input=fliplr(AreaConservingWidth_flowband');
    Width_fc_input=fliplr(FluxConservingWidth_flowband');
else
    Width_input=fliplr(Width_flowband');
    Width_fc_input=fliplr(Width_flowband');
end
...
farfieldstress=max(minbasaldrag,glstress+inversionwavelength*glstressgrad);
...
glu=SlidingVelocityScale_yr_input(lastgroundedind);
glugrad=(SlidingVelocityScale_yr_input(lastgroundedind)-SlidingVelocityScale_yr_input(lastgroundedind-1))/dx;
