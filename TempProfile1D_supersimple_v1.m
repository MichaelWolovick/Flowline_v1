function [Depth,Temp,meltrate,gflux]=TempProfile1D_supersimple_v1(BoundaryConditions,MaterialParameters,mode,gridsize)

% TempProfile1D_supersimple
...
%        beta         pressure coefficient of melting point    K/Pa
...
% internal operations follow the grid center and grid edges conventions of
% my other modeling scripts.  Suffixes: "_c" indicates grid cell centers,
% "_ud" indicates grid cell up/down edges.
...
Depth=linspace(icethick,0,gridsize);
...
% Interpolate temperature to grid edges:
Temp=[basaltemp;.5*(Temp_c(1:end-1)+Temp_c(2:end));surftemp];
